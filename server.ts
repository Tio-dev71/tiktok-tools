...
import { startDiscordWorker } from "./src/services/discordWorker";
import { runAutomationPipeline } from "./src/services/automationPipeline";
import { uploadToYouTube, uploadToFacebookReels } from "./src/services/publishService";
...
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    ...
    if (process.env.AUTO_DISCORD_ENABLED === "true") {
      startDiscordWorker();
    }
  });
}
